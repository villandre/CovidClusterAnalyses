...
fixCanadianSeqNames <- function(canadianSeqNames) {
  fixedCanadianSeqNames <- stringr::str_replace(canadianSeqNames, "Canada/Qc-", "")
  fixedCanadianSeqNames <- stringr::str_replace(fixedCanadianSeqNames, "/2020.*", "")
  fixedCanadianSeqNames
}
...
fixGISAIDseqNames <- function(GISAIDseqNames) {
  ...
  extractedNames <- stringr::str_replace_all(extractedNames, "\\|", "_")
  stringr::str_replace_all(extractedNames, "/", "-")
}
